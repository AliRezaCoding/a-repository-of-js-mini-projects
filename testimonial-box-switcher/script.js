...
const testimonialText = document.querySelector(".card__text");
const userImage = document.querySelector(".user__image");
const userName = document.querySelector(".user__desc--name");
const userRole = document.querySelector(".user__desc--role");
...
const setTestimonial = function () {
    const { name, position, photo, text } = testimonialData[currentTestimonial];
    ...
    if (currentTestimonial > testimonialData.length - 1) currentTestimonial = 0;
};

setInterval(setTestimonial, 10000);
